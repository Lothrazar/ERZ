...
public class ParticleGlowThroughBlocks extends Particle implements IRootsParticle {
	...
	public ParticleGlowThroughBlocks(World worldIn, double x, double y, double z, double vx, double vy, double vz, float r, float g, float b, float a, float scale, int lifetime) {
