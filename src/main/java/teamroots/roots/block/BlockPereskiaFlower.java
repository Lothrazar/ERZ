...
public class BlockPereskiaFlower extends BlockCrops implements IModeledBlock {
	public Item itemBlock;
	public AxisAlignedBB bounds = new AxisAlignedBB(0,0,0,1,1,1);
	public BlockPereskiaFlower(String name, boolean addToTab) {
		super();
	...
	public BlockPereskiaFlower setBoundingBox(double x1, double y1, double z1, double x2, double y2, double z2){
