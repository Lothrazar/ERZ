...
public class RegistryManager {
	...
	public static void registerAll(){
		...
		blocks.add(thatch = new BlockBase(Material.LEAVES,SoundType.PLANT,"thatch",true).setIsFullCube(true).setIsOpaqueCube(true).setRenderLayer(BlockRenderLayer.CUTOUT_MIPPED).setHardness(0.8f).setLightOpacity(0));
