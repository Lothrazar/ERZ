...
public class ParticlePetal extends Particle implements IRootsParticle {
	public float colorR = 0;
	public float colorG = 0;
	public float colorB = 0;
	public float initAlpha = 1.0f;
	public float initScale = 0;
	public ResourceLocation texture = new ResourceLocation(Const.MODID,"entity/particle_petal");
	public ParticlePetal(World worldIn, double x, double y, double z, double vx, double vy, double vz, float r, float g, float b, float a, float scale, int lifetime) {
		...
		this.motionY = vy;
		this.motionZ = vz;
		this.particleAngle = Misc.random.nextFloat()*2.0f*(float)Math.PI;
