...
public class ConfigManager {
  ...
  public static void init(File configFile) {
    ...
    entityConfigs.add(EntityWitherCat.config.setDefaultSpawns(0, 0, 0).setDefaultProperties(20, 2, 32));
    ...
    entityConfigs.add(EntityDireSlime.config.setDefaultSpawns(1, 1, 17).setDefaultProperties(12, -1, 32));//0.3F,
    ...
    entityConfigs.add(EntityFallenKnight.config.setDefaultSpawns(1, 1, 15).setDefaultProperties(20, 4, 32));
    ...
    entityConfigs.add(EntitySpriteling.config.setDefaultSpawns(4, 6, 2).setDefaultProperties(16, 4, 32).setDefaultBiome(false, new String[] { "minecraft:hell", "minecraft:sky", "minecraft:jungle_hills" }));
    ...
    entityConfigs.add(EntityGreaterSprite.config.setDefaultSpawns(1, 3, 2).setDefaultProperties(80, 6, 32).setDefaultBiome(false, new String[] { "minecraft:sky" }));
