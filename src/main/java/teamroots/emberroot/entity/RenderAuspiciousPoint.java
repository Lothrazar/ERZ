...
public class RenderAuspiciousPoint<EntityAuspiciousPoint> extends RenderEntity implements IRenderEntityLater {
	...
	public void renderLater(Entity entity, double dx, double dy, double dz, float entityYaw, float partialTicks){
		float solidity = 0;
		if (entity instanceof teamroots.emberroot.entity.EntityAuspiciousPoint){
			solidity = ((teamroots.emberroot.entity.EntityAuspiciousPoint)entity).getSolidity();
		}
        ...
        if (entity instanceof teamroots.emberroot.entity.EntityAuspiciousPoint){
            buff.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX_LMAP_COLOR);
            teamroots.emberroot.entity.EntityAuspiciousPoint point = (teamroots.emberroot.entity.EntityAuspiciousPoint)entity;
	...
	public static class Factory implements IRenderFactory<teamroots.emberroot.entity.EntityAuspiciousPoint> {
		@Override
		public Render<? super teamroots.emberroot.entity.EntityAuspiciousPoint> createRenderFor(RenderManager manager) {
