...
public class RenderPetalShell<EntityPetalShell> extends RenderEntity implements IRenderEntityLater {
	...
	public void renderLater(Entity entity, double dx, double dy, double dz, float entityYaw, float partialTicks){
		teamroots.emberroot.entity.EntityPetalShell shell = (teamroots.emberroot.entity.EntityPetalShell)entity;
	...
	public static class Factory implements IRenderFactory<teamroots.emberroot.entity.EntityPetalShell> {
		@Override
		public Render<? super teamroots.emberroot.entity.EntityPetalShell> createRenderFor(RenderManager manager) {
