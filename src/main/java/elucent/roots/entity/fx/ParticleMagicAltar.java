...
public class ParticleMagicAltar extends Particle {
	...
	public ParticleMagicAltar(World worldIn, double x, double y, double z, double vx, double vy, double vz, double r, double g, double b) {
