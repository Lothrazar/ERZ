...
public class BlockStandingStoneRepulsor extends TEBlockBase implements ITileEntityProvider {
	public static final PropertyEnum topState = PropertyEnum.create("topq", BlockStandingStoneRepulsor.isTop.class);
...
>>>>>>> 513884af035d63cee30da3c9f8d1ffd5b51b0114
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		if (meta == 1){
			return new TileEntityStandingStoneRepulsor();
		}
		return null;
	}
