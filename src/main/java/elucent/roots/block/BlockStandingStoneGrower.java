...
public class BlockStandingStoneGrower extends TEBlockBase implements ITileEntityProvider {
	public static final PropertyEnum topState = PropertyEnum.create("topq", BlockStandingStoneGrower.isTop.class);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		if (meta == 1){
			return new TileEntityStandingStoneGrower();
		}
		return null;
	}
}
