...
public class BlockSpiritFont extends TEBlockBase implements ITileEntityProvider {
	public static final PropertyEnum topState = PropertyEnum.create("topq", BlockSpiritFont.isTop.class);
	...
	public BlockSpiritFont(){
		super(Material.ROCK);
		setUnlocalizedName("spiritFont");
	...
	public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess world, BlockPos pos){
		if (this.getMetaFromState(state) == 0){
			...
			return new AxisAlignedBB(0.125,0,0.125,0.875,0.25,0.875);
		}
	}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		if (meta == 1){
			return new TileEntitySpiritFont();
		}
		return null;
	}
}
