...
public class ModelGreaterSprite extends ModelBase
{
  ...
  public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale){
	  ...
	  setRotation(body2, -2.0f*(((EntityGreaterSprite)entity).prevPitch1-((EntityGreaterSprite)entity).rotationPitch), -2.0f*(((EntityGreaterSprite)entity).prevYaw1-((EntityGreaterSprite)entity).rotationYaw), 0);
	  setRotation(body3, 0.5f*(float)Math.PI-2.0f*(((EntityGreaterSprite)entity).prevPitch2-((EntityGreaterSprite)entity).prevPitch1), -2.0f*(((EntityGreaterSprite)entity).prevYaw2-((EntityGreaterSprite)entity).prevYaw1), 0);
	  setRotation(body4, -2.0f*(((EntityGreaterSprite)entity).prevPitch3-((EntityGreaterSprite)entity).prevPitch2), 0, 2.0f*(((EntityGreaterSprite)entity).prevYaw3-((EntityGreaterSprite)entity).prevYaw2));
	  setRotation(body5, -2.0f*(((EntityGreaterSprite)entity).prevPitch4-((EntityGreaterSprite)entity).prevPitch3), 0, 2.0f*(((EntityGreaterSprite)entity).prevYaw4-((EntityGreaterSprite)entity).prevYaw3));
	  GlStateManager.rotate(-0.5f*(float)Math.PI-(float)Math.toDegrees(entity.rotationYaw), 0, 1, 0);
	  GlStateManager.rotate((float)Math.toDegrees(-entity.rotationPitch/2.0f), 1, 0, 0);
	  if (((EntityGreaterSprite)entity).twirlTimer > 0){
		  GlStateManager.rotate((float)18.0f*(20.0f-(float)((EntityGreaterSprite)entity).twirlTimer),0,0,1);
