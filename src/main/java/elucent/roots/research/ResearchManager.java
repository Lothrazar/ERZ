...
public class ResearchManager {
	...
	public static void init(){
		...
		globalResearches.add(new ResearchGroup("spells","Spellcraft")
						...
						.addResearch(new ResearchBase("CharmOfRestoration", new ItemStack(RegistryManager.itemCharmRestoration))
								.addPage(new ResearchPage()
										.addDisplayItem(new ItemStack(RegistryManager.itemCharmRestoration))
										.addMortarRecipe(ComponentManager.getRecipe("CharmOfRestoration"))
								))
                        .addResearch(new ResearchBase("CharmOfIllusion", new ItemStack(RegistryManager.itemCharmIllusion))
                                .addPage(new ResearchPage()
                                        .addDisplayItem(new ItemStack(RegistryManager.itemCharmIllusion))
                                        .addMortarRecipe(ComponentManager.getRecipe("CharmOfIllusion"))
                                ))
                .addResearch(new ResearchBase("CharmOfConjuration", new ItemStack(RegistryManager.itemCharmConjuration))
                        .addPage(new ResearchPage()
                                .addDisplayItem(new ItemStack(RegistryManager.itemCharmConjuration))
                                .addMortarRecipe(ComponentManager.getRecipe("CharmOfConjuration"))
                        ))
        );
